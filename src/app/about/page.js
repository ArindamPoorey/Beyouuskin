  ...
  return (
    <>
      <style>{`
        ...
        .about-btn { transition: transform 0.2s ease, box-shadow 0.2s ease !important; }
        .about-btn:hover {
        ...
        .phil-big-card:hover { transform: translateY(-6px) rotate(0.5deg); box-shadow: 0 20px 56px rgba(60,35,20,0.18); }
        .phil-big-card img { width: 100%; height: 100%; object-fit: cover; display: block; transition: transform 0.6s ease; }
        .phil-big-card:hover img { transform: scale(1.06); }
        .phil-big-overlay { position: absolute; inset: 0; background: linear-gradient(to top, rgba(0,0,0,0.6) 0%, transparent 50%); }
        .phil-big-label { position: absolute; bottom: 24px; left: 24px; right: 24px; }
        .phil-big-label h3 {
        ...
        .phil-small-card {
          background: var(--sand-light); border-radius: var(--radius-xl);
        ...
        .value-emoji { font-size: 36px; display: block; margin-bottom: 14px; transition: transform 0.35s cubic-bezier(0.34,1.56,0.64,1); }
        ...
        .pillar-circle {
          width: 60px; height: 60px; background: var(--sand-light);
          ...
          <div className="container">
            <Reveal direction="scale">
              <div className="hero-img-wrap" style={{ height: 420 }}>
                <img src="aboutsec.jpg" alt="Natural skincare ingredients" />
            ...
            <div className="phil-grid">
              <Reveal direction="left">
                <div className="phil-big-card" style={{ minHeight: 400 }}>
                  <img src="arti.jpg" alt="Artisanal process" />
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                ...
                <Reveal direction="right" delay={0.2}>
                  <div className="phil-big-card" style={{ minHeight: 180 }}>
                    <img src="https://images.unsplash.com/photo-1543362906-acfc16c67564?w=600&q=80" alt="Natural ingredients" />
                    <div className="img-sheen" />
                  </div>
                </Reveal>
              </div>
